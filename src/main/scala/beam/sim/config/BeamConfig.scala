    ...
    object Exchange {
      ...
      object Scenario {
        case class Urbansim(
          ...
          chanceOfRemovingWorkActivity : scala.Double
        )
        object Urbansim {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Exchange.Scenario.Urbansim = {
            BeamConfig.Beam.Exchange.Scenario.Urbansim(
              ...
              chanceOfRemovingWorkActivity = if(c.hasPathOrNull("chanceOfRemovingWorkActivity")) c.getDouble("chanceOfRemovingWorkActivity") else 0.0
            )
          }
        }
