...
#echo "starting as: singularity exec -B $SINGULARITY_BINDPATH --network host beam_production-gemini-develop-1.sif  /usr/local/openjdk-8/bin/java  $JAVA_OPTS  --config /app/$config  2>&1 "
...
## problem is that singularity 3.2 isn't likely taking options at the end to pass to the java cmd ?
## upgrade
## or write a wrapper 
